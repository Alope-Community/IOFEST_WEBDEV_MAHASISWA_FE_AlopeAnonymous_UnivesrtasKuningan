<template>
  ...
  >
    ...
    <div
      class="border-2 border-blue-500 border-dashed p-5 flex flex-col justify-center lg:order-7 md:order-5 order-3 lg:col-span-1 md:col-span-2 aos-init aos-animate"
      data-aos-once="true"
      data-aos="zoom-in"
      data-aos-delay="800"
    >
