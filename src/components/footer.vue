<template>
  <footer class="text-center mt-20">
    <hr class="border-t-4 border-blue-500 w-4/5 mx-auto my-10" />
    <div class="flex flex-col gap-10 pb-10">
      <div class="links flex flex-wrap justify-center gap-4 mb-4 px-5">
        <router-link
          to="/"
      ...
      <div class="socials flex justify-center gap-6 text-xl mb-4 text-gray-800">
        ...
        ></router-link>
        <router-link to="#"
          ><i class="fa-brands fa-x-twitter hover:text-black"></i
        ></router-link>
        <router-link to="#"
      ...
      <div class="font-semibold text-sm text-gray-800">
        <p>Pijar Nusantara | &copy; AlopeAlpha 2025</p>
      </div>
    </div>
  </footer>
</template>
